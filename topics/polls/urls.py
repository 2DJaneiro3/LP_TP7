...
urlpatterns = [
    ...
    path('signup/', views.signup, name='signup'),  # Página de registo
    path('login/', views.CustomLoginView.as_view(), name='login'),  # Página de login
    path('logout/', views.userLogout, name='logout'),  # Logout,
    ...
    path('comment/edit/<int:comment_id>/', views.edit_comment, name="edit_comment"),  # Edição de de comentários
    path('comment/delete/<int:comment_id>/', views.delete_comment, name="delete_comment"),  # Exclusão de comentários
]
